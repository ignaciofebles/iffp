...
class MoveForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        # Obtener el request si está presente
        self.request = kwargs.pop('request', None)  # Obtener request, si existe
        user = kwargs.pop('usuario', None)  # Obtener usuario, si existe
        ...
        if user:
            ...
            banks_with_balance = []
            for bank in banks:
                saldo = get_bank_balance(self.request, bank) if self.request else 0
            ...
            # Filtrar los conceptos por el usuario
